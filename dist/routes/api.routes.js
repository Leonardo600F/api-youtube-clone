...
const youtubeSearch_1 = require("../modules/youtube/services/youtubeSearch");
...
apiRoutes.get('/search', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const { search } = request.query;
    const videosResults = yield (0, youtubeSearch_1.searchYoutubeVideos)(String(search));
